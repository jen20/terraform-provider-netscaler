...
vendor-status: ## Run dep status over the provider
	@dep status

vendor-update: ## Update vendored packages
	@dep ensure -update
...
.PHONY: build test testacc vet fmt fmtcheck errcheck vendor-status vendor-update test-compile
